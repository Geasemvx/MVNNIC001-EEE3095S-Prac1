...
#define PATTERN1 0b00000000000000000000000010010111;
#define PATTERN2 0b00000000000000000000000001001011;
#define PATTERN3 0b00000000000000000000000000100101;
#define PATTERN4 0b00000000000000000000000000010010;
#define PATTERN5 0b00000000000000000000000000001001;
#define PATTERN6 0b00000000000000000000000000000100;
#define PATTERN7 0b00000000000000000000000000000010;
#define PATTERN8 0b00000000000000000000000000000000;
static uint8_t currentPattern = 0;
static uint8_t numPatterns = 8;
static uint32_t lastPatternChangeTime = 0;
...
int main(void)
{
  ...
  while (1)
  {
    ...
    // TODO: Check pushbuttons to change timer delay
	  // Check button states
	  // Read button states
	          uint32_t button0State = HAL_GPIO_ReadPin(Button0_GPIO_Port, Button0_Pin);
	          uint32_t button1State = HAL_GPIO_ReadPin(Button1_GPIO_Port, Button1_Pin);
	          uint32_t button2State = HAL_GPIO_ReadPin(Button2_GPIO_Port, Button2_Pin);
	          uint32_t button3State = HAL_GPIO_ReadPin(Button3_GPIO_Port, Button3_Pin);
...
void TIM16_IRQHandler(void)
{
    ...
    /*init_LCD();
    lcd_command(CLEAR);
    lcd_putstring("Delay Time");
    lcd_command(0xC0);
    if(delayMilliSeconds==999)
       lcd_putstring("1 second");
    else if(delayMilliSeconds==499)
       lcd_putstring("0.5 seconds");
    else if(delayMilliSeconds==1999)
       lcd_putstring("2 seconds");*/
